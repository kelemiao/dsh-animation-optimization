/**
 * dsh-animation-optimization — client half (v28).
 *
 * v28: renamed from dsh-theme-photo-editorial to dsh-animation-optimization;
 * the plugin id, settings slots, style attributes and localStorage keys now
 * use the new package name so DSH recognizes it as one official-style
 * extension.
 * v27: streaming covers pwsh terminal output, write and edit diffs — the
 ...
 */
window.__ModuleLoader__.load({ id: "dsh-animation-optimization", factory: (require) => {
